...
class Edrone():
	...
	def __init__(self):
		...
		self.setpoint = [-7.62, -0.761, 27.754] # whycon marker at the position of the dummy given in the scene. Make the whycon marker associated with position_to_hold dummy renderable and make changes accordingly
		...
		#self.Kp = [12.48,12.62,55.88]
		#self.Ki = [0,0,0]    
		#self.Kd = [588.2,1038.8,895.7]
