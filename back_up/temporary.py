...
class Edrone():
	...
	def __init__(self):
		...
		#self.setpoint = [0.2, 0, 23] # whycon marker at the position of the dummy given in the scene. Make the whycon marker associated with position_to_hold dummy renderable and make changes accordingly
		...
		#self.Kp = [19.68,10.5,73.38]
		#self.Ki = [0.004,0.086,0]    
		#self.Kd = [380.3,570,550]

		#self.Kp = [62.48,41.62,62.88]
		#self.Ki = [0.0005,0.0085,-0.0295]    
		#self.Kd = [1588.2,1038.8,895.7]

		#self.Kp = [56.98,47.62,55.88]
		#self.Ki = [0.00075,0.0035,0.0055]
		#self.Kd = [1750,1338.8,795.7]

		#self.Kp = [58.48,45.62,62.88]
		#self.Ki = [0.00075,0.00089,0.0795] #markers1   
		#self.Kd = [1784.2,1338.8,895.7]

		#self.Kp = [54.88,41.62,55.88]
		#self.Ki = [0.00075,0.00062,0.0785]    
		#self.Kd = [1584.2,1042.8,695.2] #mock1

		#self.Kp = [55.48,41.62,62.88]
		#self.Ki = [0.0035,0.0085,-0.0295]    
		#self.Kd = [1288.2,1038.8,895.7]


		#self.Kp = [62.48,47.62,62.88]
		#self.Ki = [0.0195,0.0003,-0.0295]    
		#self.Kd = [1484.2,1138.8,995.7]

		#self.Kp = [28.48,29.62,55.88]
		#self.Ki = [0.0025,0.00013,0.0395]    
		#self.Kd = [984.2,842.8,995.2]

		#self.Kp = [45.88,42.68,62.88]
		#self.Ki = [0.00075,0.00089,0.000785]    
		#self.Kd = [1284.2,1362.65,695.2]

		#self.Kp = [45.88,29.62,62.88]
		#self.Ki = [0.00075,0.00089,-0.0795]    
		...
		self.Kp = [62.48,43.62,55.88]
		self.Ki = [0.0055,0.0035,0.0055]    
		self.Kd = [1388.2,1038.8,795.7]

		#self.Kp = [48.48,40.62,62.88]
		#self.Ki = [0.0195,0,-0.0695]    
		#self.Kd = [1264.2,1198.8,995.7]
	...
	#	8. Add error_sum
		...
		if timechange > self.sample_time:
			...
			self.out[0]=self.Kp[1] * self.error[1] +self.Iterm[1] + self.Kd[1] * chg_errorp
			...
			self.out[1]=self.Kp[0] * self.error[0] +self.Iterm[0] + self.Kd[0] * chg_errorR
		...
		#self.cumulative_duration=self.cumulative_duration+1
		print("Drone at  "+self.s+"  Cumulative time: "+str(round(self.duration,2)))
		#print(round(float(self.cumulative_duration)))
		if self.drone_position[0]>=(self.setpoint[0]-0.5) and self.drone_position[0]<=(self.setpoint[0]+0.5) and self.drone_position[1]>=(self.setpoint[1]-0.5) and self.drone_position[1]<=(self.setpoint[1]+0.5) and self.drone_position[2]>=(self.setpoint[2]-0.5) and self.drone_position[2]<=(self.setpoint[2]+0.5):
			...
			#print("Drone at  "+self.s+"  Cumulative time: "+str(self.cumulative_duration)+'\r'),			
		else:
			self.start_time = time.time()
